...
export default function Hero() {
  ...
  const countryDialCodes = {
    ...
    Uganda: "+256", Ukraine: "+380", UnitedArabEmirates: "+971", UnitedKingdom: "+44", UnitedStates: "+1",
  ...
  const [formData, setFormData] = useState({
    ...
    companyName: "", companySize: "", country: "", referral: "",
    usingCRM: "", existingCRMName: "", consent: false,
  });
  ...
  const handleSubmit = async (e) => {
    ...
    const {
      firstName, lastName, email, phone, jobTitle,
      companyName, companySize, country, referral,
      usingCRM, existingCRMName, consent,
    } = formData;
    ...
    <div className="w-full flex flex-col items-center px-4 pt-10 bg-white relative overflow-hidden">
      ...
      <div
        className="
          ...
          mt-[-20px] sm:mt-[-100px] md:mt-[-150px] lg:mt-[-200px] xl:mt-[-285px]
          w-full max-w-[1440px] px-4
          min-h-[180px] sm:min-h-[300px] [max-width:440px]:[min-width:300px]:w-[500%]
        "
      >
        {/* Background Image (Hidden on ≤ 420px) */}
        <img
          src="/images/Vector.png"
          alt="Hero Background"
          className="w-full h-auto object-cover max-[420px]:hidden"
        />

        {/* Foreground Image - left icon (Always visible) */}
        <img
          src="/images/left-icon.png"
          alt="Hero Foreground"
          className="
            ...
            transform -translate-x-1/2
            w-[125px] sm:w-[250px] md:w-[370px] lg:w-[500px] xl:w-[575px]
            top-custom-300-399 w-custom-300-399 left-custom-300-399 left-custom-300-399
            top-custom-400-420 w-custom-400-420 left-custom-401-420
            top-custom-421-500 w-custom-421-500
            top-custom-501-600 w-custom-501-600
            top-custom-601-699 w-custom-601-699 left-custom-601-699
            top-custom-701-799 w-custom-701-799 left-custom-701-799
            top-custom-800-899 w-custom-800-899 left-custom-800-899
            top-custom-900-1000 w-custom-900-1000 left-custom-900-1000
            top-custom-1024-1100 w-custom-1024-1100 left-custom-1024-1100
            top-custom-1101-1200 w-custom-1101-1200 left-custom-1101-1200
            z-10"
        />

        {/* Foreground Image - right icon (Always visible) */}
        <img
          src="/images/right-icon.png" 
          alt="Hero Foreground"
          className="
